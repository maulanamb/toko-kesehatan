...
// 't' = jumlah hari di bulan yang dipilih
$tanggal_akhir = date("Y-m-t 23:59:59", strtotime($tanggal_awal));

// --- 1. Query untuk KPI (Key Performance Indicators) ---
// Ambil total pendapatan dan jumlah pesanan yang statusnya BUKAN 'Dibatalkan'
$sql_kpi = "SELECT 
...
// --- 2. Query untuk Produk Terlaris di bulan ini ---
$sql_produk = "SELECT 
                   p.product_name, 
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="laporan.php">Laporan Bulanan</a></li> </ul>
    </div>
    ...
    <div class="content">
        ...
        <div class="kpi-container">
            <div class="kpi-card">
                ...
                <div class="nilai">Rp <?php echo number_format($total_pendapatan, 0, ',', '.'); ?></div>
            </div>
            <div class="kpi-card">
        ...
        <h3>10 Produk Terlaris Bulan Ini</h3>
        <table>
            <thead>
                <tr>
                    <th>No.</th>
